 ...
 * a su lista de pasos, y Claude Code no usa ninguno de los tres.
 *
...
export const TOOL_CATEGORIES: readonly ToolCategory[] = [
  {
    key: 'shell',
    names: ['Bash', 'PowerShell', 'BashOutput', 'KillShell', 'shell_command'],
  ...
  { key: 'edit', names: ['Edit', 'Write', 'NotebookEdit', 'MultiEdit', 'apply_patch'], label: 'ediciones' },
  { key: 'web', names: ['WebSearch', 'WebFetch', 'ToolSearch'], label: 'busquedas' },
  { key: 'agent', names: ['Task', 'Agent'], label: 'subagentes' },
  { key: 'todo', names: ['TodoWrite', 'update_plan'], label: 'listas de tareas' },
];
